...
class OneiricMCPServer:
    ...
    def __init__(
        ...
        logger.info(f"Oneiric MCP Server initialized (auth={enable_auth})")
    ...
    def register_adapter(
        ...
        logger.info(
            f"Registered adapter '{name}' (type={adapter_type}, version={version})"
        )
    ...
    def list_adapters(self, adapter_type: str | None = None) -> dict[str, Any]:
