...
from druva.core.persistent import Persistent, _setattribute
from druva.serialize.base import DEFAULT_MAX_SIZE, Serializer
...
DEFAULT_ALLOWED_MODULES: set[str] = {
    ...
    "druva",
    "druva.collections",
    "druva.collections.dict",
    "druva.collections.list",
    "druva.collections.set",
    "druva.collections.btree",
    "druva.core",
    "druva.core.persistent",
    "druva.core.connection",
