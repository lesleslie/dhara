...
class DruvaShell(AdminShell):
    ...
    Example:
        ...
        >>> from druva.storage.file_storage import FileStorage
    ...
    def __init__(
        ...
        self.session_tracker = DruvaSessionTracker(
            component_name="druva",
        )
        self._session_id: str | None = None

    def _add_druva_namespace(self) -> None:
    ...
    def _get_component_name(self) -> str | None:
        ...
        Returns:
            Component name "druva" for session tracking
        """
        return "druva"
    ...
    def _get_component_version(self) -> str:
        ...
        try:
            ...
            return importlib_metadata.version("druva")
        except Exception:
            return "unknown"
...
"""
    ...
    async def _push_adapters(self) -> None:
        ...
        try:
            from oneiric.adapters.druva_pusher import push_adapters_on_startup
