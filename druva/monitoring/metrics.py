"""Prometheus metrics collection for druva.
...
class MetricsCollector:
    """Collects and tracks Prometheus metrics for druva operations.
    ...
    def __init__(self):
        ...
        self._storage_operations = Counter(
            "druva_storage_operations_total",
        ...
        self._storage_duration = Histogram(
            "druva_storage_operation_duration_seconds",
        ...
        self._cache_hits = Counter(
            "druva_cache_hits_total",
            "Total cache hits",
            registry=self._registry,
        )

        self._cache_misses = Counter(
            "druva_cache_misses_total",
            "Total cache misses",
            registry=self._registry,
        )
        ...
        self._active_connections = Gauge(
            "druva_active_connections",
            "Currently active connections",
            registry=self._registry,
        )

        self._total_connections = Counter(
            "druva_connections_total",
