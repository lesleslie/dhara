...
class SecurityConfig:
    ...
    fallback_signing_key: bytes | None = None
    ...
    def _initialize_fallback(self) -> None:
        ...
        with self._fallback_lock:
            ...
            self._log_security_event(
                "Security configuration initialized in fallback mode"
            )
    ...
    def _validate_security_setup(self) -> None:
        ...
        try:
            ...
            if signing_key["is_expired"]:
                raise ValueError(
                    f"Signing key has expired: {signing_key['expires_at']}"
                )
