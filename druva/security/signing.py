"""
Cryptographic object signing for druva.
...
class ObjectSigner:
    ...
    def sign_record(self, oid: bytes, data: bytes, refs: bytes) -> bytes:
        ...
        This is the main method for signing druva storage records.
...
class SignedStorage:
    ...
    Example:
        ...
        from druva.security.signing import SignedStorage, ObjectSigner

        signer = ObjectSigner.from_password(b"my-secret-key")
        base_storage = FileStorage("data.druva")
...
def create_signer_from_env(env_var: str = "DRUVA_SIGNING_KEY") -> ObjectSigner:
