...
class BackupManager:
    ...
    def perform_full_backup(self) -> BackupMetadata:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if isinstance(self.storage, FileStorage):
                ...
                raise NotImplementedError("Full backup not implemented for this storage type")
    ...
    def perform_incremental_backup(self, last_backup_id: Optional[str] = None) -> BackupMetadata:
        ...
        last_backup = catalog.get_backup(last_backup_id) if last_backup_id else catalog.get_last_backup()
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if isinstance(self.storage, FileStorage):
                ...
                raise NotImplementedError("Incremental backup not implemented for this storage type")
    ...
    def perform_differential_backup(self, last_full_backup_id: Optional[str] = None) -> BackupMetadata:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if isinstance(self.storage, FileStorage):
                ...
                raise NotImplementedError("Differential backup not implemented for this storage type")
    ...
    def upload_to_cloud(self, backup_metadata: BackupMetadata) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Backup uploaded successfully: {backup_metadata.backup_id}")
            return True
