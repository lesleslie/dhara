...
class DurusMCPServer:
    ...
    def durus_list(self, prefix: Optional[str] = None) -> Dict[str, Any]:
...
def create_server_from_config(config: Dict[str, Any]) -> DurusMCPServer:
    """
    ...
    Returns:
        Configured DurusMCPServer instance
    """
