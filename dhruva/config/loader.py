...
from dhruva.config.defaults import (
    DhruvaConfig,
)
...
def load_config(
    ...
    Returns:
        Validated DhruvaConfig instance
    ...
    if isinstance(source, dict):
        return DhruvaConfig.from_dict(source)
    ...
    return DhruvaConfig.from_dict(data)
...
def load_config_from_env(
    ...
    Returns:
        DhruvaConfig instance if config file is found, None otherwise
...
def save_config(
    ...
    Args:
        config: DhruvaConfig instance to save
...
def merge_configs(*configs: DhruvaConfig) -> DhruvaConfig:
    ...
    Args:
        *configs: DhruvaConfig instances to merge

    Returns:
        Merged DhruvaConfig instance

    Examples:
        >>> default = DhruvaConfig()
        >>> override = DhruvaConfig(storage=StorageConfig(backend='memory'))
